...
export default function Home() {
  ...
  <main className="min-h-screen bg-gray-900 text-gray-100">
    ...
    <div className="container mx-auto px-6 text-center">
      <div className="mb-4 inline-flex items-center justify-center border border-white rounded-lg px-3 py-1">
        <span className="text-gray-300 text-md">
          Powered by <span className="font-medium text-white">Llama 3.3</span> and{" "}
    ...
    <div className="-mt-2">
      <Link href="https://github.com/jei3m" target="_blank" rel="noopener noreferrer">
        <button
          className="bg-gray-700 text-white px-5 py-3 border-2 border-white rounded-full font-bold hover:bg-gray-800 transition duration-300 flex align-center mx-auto"
        >
